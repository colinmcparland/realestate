  ...
  return (
    <PageContainer alignContent="flex-start" rowGap="medium">
      <GridContainer rowGap="small">
        <StyledText size="h1">Privacy Policy</StyledText>
        <StyledText>
          Your privacy is important to us. It is Toronto Home Value&apos;s
          ...
          you, including across our website, https://torontohomevalue.ca, and
          other sites we own and operate.
        </StyledText>
        <StyledText>
          This policy is effective as of 1 March 2021 and was last updated on 1
          March 2021.
        </StyledText>
        <StyledText size="h3">Information We Collect</StyledText>
        <StyledText>
        ...
        <StyledText size="h3">Log Data</StyledText>
        <StyledText>
        ...
        <StyledText size="h3">Personal Information</StyledText>
        <StyledText>
        ...
        <StyledText>• Phone/mobile number</StyledText>
        <StyledText>• Home/mailing address</StyledText>
        <StyledText size="h3">
        ...
        <StyledText size="h3">Collection and Use of Information</StyledText>
        ...
        <StyledText>• When you mention us on social media</StyledText>
        ...
        <StyledText>• to contact and communicate with you</StyledText>
        <StyledText>
        ...
        <StyledText size="h3">Security of Your Personal Information</StyledText>
        ...
        <StyledText>
          owever, if necessary, we may retain your personal information for our
          compliance with a legal, accounting, or reporting obligation or for
          archiving purposes in the public interest, scientific, or historical
          research purposes or statistical purposes.
        </StyledText>

        <StyledText size="h3">Children’s Privacy</StyledText>
        ...
        <StyledText size="h3">Limits of Our Policy</StyledText>

        <StyledText>
          ur website may link to external sites that are not operated by us.
        ...
        <StyledText size="h3">Changes to This Policy</StyledText>
        ...
        <StyledText size="h3">Contact Us</StyledText>
        ...
        <StyledText onClick={() => window.open("mailto:rt@richardtuck.ca")}>
          Contact Us
        </StyledText>
      </GridContainer>
